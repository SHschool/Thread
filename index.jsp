            ...
            <div class="row">
                ...
                <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 d-none d-md-block">
                    <div class="row d-flex flex-column align-items-center">
                        <i class="fab fa-twitter fa-fw fa-3x my-4" style="color:green"></i>
                        <i class="fas fa-home fa-fw fa-2x my-3" style="color: cornflowerblue;"></i>
                        <i class="fas fa-hashtag fa-fw fa-2x my-3"></i>
                        <i class="far fa-bell fa-fw fa-2x my-3"></i>
                        <i class="far fa-envelope fa-fw fa-2x my-3"></i>
                        <i class="far fa-user fa-fw fa-2x my-3"></i>
                    </div>
                </div>
                ...
                <div class="col-xl-7 col-lg-9 col-md-9 col-sm-9 col-12">
                    ...
                    <div class="row border-left border-right border-bottom">
                        ...
                        <div class="col-xl-11 col-lg-10 col-md-10 col-sm-10 col-9 mt-3">
                            ...
                            <span class="h5 ml-3 text-muted">投稿日時</span>
                            <p class="h3 mt-2">
                            ...
                            <form method="POST" action="後で" class="needs-validation" novalidate>
                                <div class="form-group">
                                    <div class="input-group input-group-lg mt-4">
                                        <input type="text" class="form-control form-control-lg rounded" id=""
                                            placeholder="いまどうしてる？" required>
                                ...
                                <div class="text-right mt-4">
                                    <button class="btn btn-primary btn-lg my-3 rounded-pill"
                                        type="submit"><span>ツイートする</span></button>
                                </div>
                            </form>
                        </div>
                    </div>
