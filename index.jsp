                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-1 d-none d-md-block">
                            <div class="row d-flex flex-column align-items-center">
                                <a href="thread" style="color: cornflowerblue;"><i class="fab fa-twitter fa-fw fa-3x my-4"></i></a>
                                ...
                                <button class="btn btn-primary rounded-circle mt-2" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">+</button>
                            </div>
                        </div>
                            ...
                            <c:forEach var="thread" items="${threads}">
                                <div class="row border border-top-0">
                                    ...
                                    <div class="col-xl-11 col-lg-10 col-md-10 col-sm-10 col-9 mt-4">
                                        ...
                                        <p class="h4 my-2"><c:out value="${thread.content}" /></p>
                                        <p class="h4 my-2"><c:out value="${thread.tag}" /></p>
                                        <div class="row">
                                            <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-row ">
                            ...
                            <div class="col-3 my-2 ml-2">
                                <button class="btn btn-primary rounded-circle" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">+</button>
                            </div>
                        </div>
                    </div>
                </div>
