                                    ...
                                    <div class="col-xl-11 col-lg-10 col-md-10 col-sm-10 col-9" style="border-bottom: 3px solid #DBE9FF; border-right: 3px solid #DBE9FF;">
                                        <form method="POST" action="thread" class="userInfo">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="tag" class="form-control form-control-lg mt-3" placeholder="タグを入力して下さい" data-max-length="60">
                                            </div>
                                            <div class="text-right">
                                                <button type="submit" class="btn btn-primary btn-lg my-3 mb-2 rounded-pill font-weight-bold"><span>つぶやく</span></button>
                                            </div>
                                        </form>
                                    </div>
                                    <!-- formここまで -->
